...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	//++ Бормотов А.Ю.
	Движения.ВКМ_ПроведенныеРеализацииТоваровУслуг.Записывать = Истина;
	
	Движение = Движения.ВКМ_ПроведенныеРеализацииТоваровУслуг.Добавить();
	...
	Движение.СуммаТовары = Товары.Итог("Сумма");
	Движение.СуммаУслуги = Услуги.Итог("Сумма");
...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	ДанныеДоговора = ВКМ_Служебный.ПолучитьИнформациюОДоговоре(Договор);
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			НоваяСтрока.Цена = Выборка.СтоимостьЧасаРаботы;
